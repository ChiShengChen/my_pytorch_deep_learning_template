...
def train(nb_epoch, batch_size, store_name, start_epoch=0, model_path=None, data_path = '', class_num):
    ...
    net = Network_Wrapper(net_layers, class_num) # need to modify the class number
...
if __name__ == '__main__':
    ...
    train(nb_epoch=200,             # number of epoch
             ...
             store_name='Results_cnfood241_ResNet50',     # folder for output
